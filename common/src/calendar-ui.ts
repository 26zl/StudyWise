...
export const COURSE_BORDER_CLASSES: Record<CourseColor, string> = {
  ...
  cyan: "border-l-cyan-500 dark:border-l-cyan-600",
  pink: "border-l-pink-500 dark:border-l-pink-600",
  indigo: "border-l-indigo-500 dark:border-l-indigo-600",
  teal: "border-l-teal-500 dark:border-l-teal-600",
  orange: "border-l-orange-500 dark:border-l-orange-600",
  lime: "border-l-lime-500 dark:border-l-lime-600",
  rose: "border-l-rose-500 dark:border-l-rose-600",
  violet: "border-l-violet-500 dark:border-l-violet-600",
  emerald: "border-l-emerald-500 dark:border-l-emerald-600",
  sky: "border-l-sky-500 dark:border-l-sky-600",
  fuchsia: "border-l-fuchsia-500 dark:border-l-fuchsia-600",
  timetable: "border-l-slate-500 dark:border-l-slate-600",
};
