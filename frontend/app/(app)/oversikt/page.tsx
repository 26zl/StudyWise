 ...
 * Viser KI-ukeplan, MinArbeidsplan, Canvas-statistikk og rask tilgang til funksjoner
 */
"use client";
...
import { MinArbeidsplan } from "../../components/MinArbeidsplan";
...
export default function OversiktPage() {
    ...
    }, [harCanvasToken]); // refetch er stabil fra React Query, kun harCanvasToken skal trigge
            ...
            <main className="flex-1 min-h-0 overflow-y-auto bg-white dark:bg-slate-900">
                <div className="min-h-full bg-slate-50 dark:bg-slate-950">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
                        ...
                        {/* Tab Navigation */}
                        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/50 p-1">
