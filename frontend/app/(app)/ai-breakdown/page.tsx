...
import { skalRedirecteTilAuth, useAuthRedirect } from "../../auth/authUtils";
import {
                ...
                <div className="flex flex-col items-center justify-center text-center space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 max-w-xl">
                      AI Task Breakdown bruker de faktiske oppgavene dine fra Canvas. Legg til Canvas-token i innstillinger før du genererer deloppgaver.
                    </p>
                  </div>
                  <Link
