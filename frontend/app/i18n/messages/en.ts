...
export const enMessages = {
  ...
  admin: {
    ...
    queues: {
      ...
      description: "Background jobs for Clerk deletion retry and Pinecone vector cleanup.",
  ...
  personvern: {
    ...
    legalBasisConsentBody: "Optional performance measurements (e.g., Speed Insights) are only enabled if you explicitly accept via the cookie banner. You can withdraw consent at any time by changing your choice in settings. If you are not logged in, the choice is remembered for 30 days via a cookie.",
