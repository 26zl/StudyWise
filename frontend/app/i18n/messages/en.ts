...
export const enMessages = {
  ...
  sharedChat: {
    ...
    notFoundOrExpired: "This conversation does not exist or is no longer shared.",
    fetchError: "Could not fetch the conversation. Try again later.",
    invalidServerData: "Invalid data from server. Try again later.",
    genericFetchError: "Something went wrong while fetching the conversation.",
    notFound: "The shared conversation does not exist.",
    loading: "Loading shared conversation...",
    sharedAt: "Shared {date}",
    expiresAt: "Expires {date}",
    badge: "StudyWise shared chat",
    disclaimer: "This link shows the entire chat as it was shared, including user messages and AI responses.",
    footer: "This page shows a shared snapshot of the entire StudyWise chat.",
  },
  profil: {
