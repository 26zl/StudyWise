...
export const enMessages = {
  ...
  admin: {
    ...
    logs: {
      ...
      description:
        "Shows the latest log lines from backend (Pino) and frontend (console.error / window.onerror) in real time via an SSE stream. Buffer holds up to 500 lines per source — restarts clear it.",
