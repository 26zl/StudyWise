export const nbMessages = {
  ...
  settings: {
    ...
    profileCompletion: {
      ...
      subtitle: "Vi trenger litt mer informasjon for å fortsette",
      description: "Det ser ut som noen profilfelt mangler eller er ufullstendige. Vennligst fyll inn informasjonen nedenfor.",
      firstName: "Fornavn",
