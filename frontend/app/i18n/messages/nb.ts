export const nbMessages = {
  ...
  admin: {
    ...
    logs: {
      ...
      description:
        "Viser siste logg-rader fra backend (Pino) og frontend (console.error / window.onerror) i sanntid via SSE-strøm. Buffer maks 500 rader per kilde — restart tømmer.",
