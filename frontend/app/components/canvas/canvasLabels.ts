...
export function getCanvasLabels(language: Language) {
  if (language === "en") {
    return {
      ...
      hiddenCoursesEmpty: "You have no hidden courses.",
      hiddenCoursesDescription:
        "Hidden courses are excluded from assignments, announcements and calendar.",
      courseHidden: "Course hidden",
      courseShown: "Course shown again",
      ...
      assignmentsEmptyDescription:
        "When you have active assignments in your Canvas courses, they will appear here.",
      showingAssignments: (filtered: number, total: number) =>
        `Showing ${filtered} of ${total} assignments`,
      assignmentFilters: {
        alle: "All",
        kommende: "Upcoming",
        forfalt: "Overdue",
      ...
      nextPage: "Next page",
      loadMore: "Load more",
      shownOfTotal: ({ shown, total }: { shown: number; total: number }) =>
  ...
  return {
    ...
    hideCourse: "Skjul emne",
    showCourse: "Vis emne",
    hiddenCourses: "Skjulte emner",
    hiddenCoursesEmpty: "Du har ingen skjulte emner.",
    hiddenCoursesDescription: "Skjulte emner ekskluderes fra oppgaver, kunngjøringer og kalender.",
    courseHidden: "Emnet er skjult",
    courseShown: "Emnet er synlig igjen",
    ...
    assignmentsEmptyDescription:
      "Når du har aktive oppgaver i Canvas-emnene dine, dukker de opp her.",
    showingAssignments: (filtered: number, total: number) =>
      `Viser ${filtered} av ${total} oppgaver`,
    assignmentFilters: {
      alle: "Alle",
      kommende: "Kommende",
      forfalt: "Forfalt",
