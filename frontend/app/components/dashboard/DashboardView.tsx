...
import { useAuthRedirect, skalRedirecteTilAuth, useFatalAuthSignOut } from "@/app/auth/authUtils";
...
const ChatSection = lazy(() =>
  import("@/app/components/chat/ChatSection").then((m) => ({ default: m.ChatSection })),
);
const CanvasSection = lazy(() =>
  import("@/app/components/canvas/canvasSection").then((m) => ({ default: m.CanvasSection })),
);
const SettingsSection = lazy(() =>
  import("@/app/components/dashboard/SettingsSection").then((m) => ({
    default: m.SettingsSection,
  })),
);
const CalendarSection = lazy(() =>
  import("@/app/calendar/CalendarSection").then((m) => ({ default: m.CalendarSection })),
);
const VarslingerSection = lazy(() =>
  import("@/app/components/dashboard/VarslingerSection").then((m) => ({
    default: m.VarslingerSection,
  })),
);
const QuizView = lazy(() =>
  import("@/app/components/ki/QuizView").then((m) => ({ default: m.QuizView })),
);
const AdminSection = lazy(() =>
  import("@/app/components/admin/AdminSection").then((m) => ({ default: m.AdminSection })),
);
...
export function DashboardView() {
  ...
  return (
    <>
      {visOnboarding && <OnboardingModal onLukk={lukkOnboarding} />}
      {aktivVisning === "chat" && (
