...
export function Sidebar({
  ...
  const { setSelectedChatId, currentChatId, setCurrentChatId, setBytterSamtale, requestNewChat } =
    useUIStore();
  ...
  const NavElement = ({
    ...
    const erAktiv =
      isActiveOverride !== undefined ? isActiveOverride : erPåDashboard && effektivVisning === view;
    return (
      <button
        type="button"
  ...
  return (
    <>
      ...
      >
        ...
        <nav
          ref={navScrollRef}
          aria-label={t("dashboard.sidebar.navigationTitle")}
          className="relative flex-1 overflow-y-auto px-5 py-5 space-y-2"
        >
          {/* Ny samtale-knapp */}
          <button
            type="button"
          ...
          <div className="mb-10">
            <div className="space-y-1.5">
              ...
              <NavElement
                ...
                isActiveOverride={
                  erPåDashboard && (effektivVisning === "quiz" || effektivVisning === "flashcards")
                }
              />
            </div>

            <div
              className={`flex items-center justify-between px-2 ${erBookmarksUtvidet ? "pt-5 pb-2" : "pt-3 pb-1"}`}
            >
              <Link
              ...
              <button
                ...
                aria-label={
                  erBookmarksUtvidet
                    ? chatHandlingTekster.hideBookmarks
                    : chatHandlingTekster.showBookmarks
                }
              >
            ...
            <div
              className={`flex items-center justify-between px-2 ${erBookmarksUtvidet ? "pt-6 pb-2" : "pt-3 pb-1"}`}
            >
              <Link
              ...
              <button
                ...
                aria-label={
                  erHistorikkUtvidet
                    ? chatHandlingTekster.hideHistory
                    : chatHandlingTekster.showHistory
                }
              >
        ...
        <div className="shrink-0 border-t border-slate-200 dark:border-slate-800 px-5 py-3 space-y-1">
          ...
          <Link
            ...
            prefetch={false}
            aria-current={
              effektivPathname === "/account" || effektivPathname.startsWith("/account/")
                ? "page"
                : undefined
            }
            onClick={() => {
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center gap-0.5">
              {visBrukerPlaceholder ? (
                <>
                  <div
                    className="h-4 w-24 rounded bg-slate-200 dark:bg-slate-700 animate-pulse"
                    aria-hidden="true"
                  />
                  <div
                    className="h-3 w-16 rounded bg-slate-200 dark:bg-slate-700 animate-pulse"
                    aria-hidden="true"
                  />
                </>
              ) : (
