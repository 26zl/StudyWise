...
function statusDotClass(status: "operational" | "degraded" | "down"): string {
  if (status === "operational") return "bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.4)]";
  if (status === "degraded") return "bg-amber-500 shadow-[0_0_10px_rgba(245,158,11,0.4)]";
