...
export const sikkerHref = (u?: string | null): string => {
  ...
  const farligeProtokoll = ["javascript:", "data:", "vbscript:", "file:"];
 ...
 */
export const sikkerFilNedlastingUrl = (
  ...
  const replace: HTMLReactParserOptions["replace"] = (domNode) => {
    if (domNode instanceof Element) {
      if (domNode.tagName === "a") {
        ...
        const resolvedHref =
          canvasBildeProxyUrl(href) ?? resolveCanvasRelativeHref(href ?? "", canvasBaseUrl);
