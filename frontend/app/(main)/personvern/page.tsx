                ...
                <div className="space-y-6">
                    <section className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                        ...
                        <ul className="space-y-3 text-slate-600 dark:text-slate-400">
                            <li><strong>Kontoinformasjon og innlogging:</strong> Innlogging håndteres av Clerk (e-post, passord og valgfri to-faktor). Du kan koble til Google, Microsoft eller Apple hvis det er aktivert. Vi lagrer ikke passord selv; Clerk håndterer sikkerhet og 2FA.</li>
                            <li><strong>Informasjonskapsler (cookies) og monitorering:</strong> Vi bruker nødvendige cookies for innlogging og preferanser. I tillegg bruker vi driftsmonitorering og feilsporing for å kunne knytte feil til backend/APM og følge stabiliteten i løsningen. Hvis du godtar det, aktiverer vi også valgfrie ytelsesmålinger. Valget for valgfrie målinger lagres lokalt i nettleseren.</li>
                    ...
                    <section className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                        ...
                        <ul className="space-y-3 text-slate-600 dark:text-slate-400">
                            <li><strong>Konto og profil:</strong> Inntil du sletter kontoen. Ved kontosletting slettes eller anonymiseres kontoopplysninger, Canvas-token, samtalehistorikk, preferanser og arbeidsplaner. Begrensede sikkerhets- og revisjonslogger kan beholdes i pseudonymisert eller minimert form i opptil 24 måneder.</li>
                            ...
                            <li><strong>Sesjoner:</strong> Innlogging og sesjoner håndteres av Clerk. Session-token utløper etter Clerk sin konfigurasjon og oppdateres av innloggingsleverandøren ved behov.</li>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                        ...
                        <ul className="space-y-3 text-slate-600 dark:text-slate-400">
                            ...
                            <li><strong>Monitorering (Datadog):</strong> Tekniske drifts- og feilsporingsdata kan behandles av Datadog for å knytte frontend-feil, backend-spor og ytelsesavvik sammen. Dette omfatter tekniske metadata, ikke innholdet i Canvas-token eller chat-meldinger.</li>
                        </ul>
                    </section>
                    ...
                    <section className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                        ...
                        <ul className="space-y-3 text-slate-600 dark:text-slate-400">
                            ...
                            <li><strong>Retting:</strong> Du kan oppdatere e-post, passord og to-faktor under Innstillinger → Konto og sikkerhet (rediger profil). Canvas-token og preferanser kan du endre eller fjerne under innstillinger.</li>
                            <li><strong>Sletting:</strong> Du kan slette enkelt samtaler eller hele chat-historikken i appen, og slette Canvas-token under innstillinger. Full kontosletting kan gjøres under innstillinger eller ved å kontakte oss. Da slettes eller anonymiseres kontoopplysninger og tilknyttede data, mens begrensede sikkerhets- og revisjonslogger kan beholdes i pseudonymisert form i en begrenset periode.</li>
                    ...
                    <section className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-800">
                        ...
                        <ul className="space-y-3 text-slate-600 dark:text-slate-400">
                            ...
                            <li>Innlogging og passord håndteres av Clerk; vi lagrer ikke passord selv. Clerk støtter to-faktor (2FA) og tilkobling til Google, Microsoft og Apple.</li>
                            <li>Sikkerhets- og revisjonslogger minimeres og pseudonymiseres ved kontosletting der det er praktisk mulig, men enkelte tekniske metadata kan beholdes i begrenset tid for sikkerhet, misbruksdeteksjon og etterlevelse.</li>
