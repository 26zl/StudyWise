    ...
    const sikkerhetsTiltak = [
        {
            icon: Lock,
            title: "Kryptering",
            description: "Alle sensitive data krypteres med AES-256-GCM for lagring. Innlogging og passord håndteres av Clerk; vi lagrer ikke passord selv. Clerk støtter 2FA og sikker lagring.",
        },
        {
            icon: Key,
        ...
        },
        {
            ...
            description: "Innlogging og sesjoner håndteres av Clerk med sikre cookies (httpOnly, secure, sameSite). Clerk støtter to-faktor (2FA) og innlogging med Google, Microsoft og Apple. Tilgangstoken har kort levetid og sendes kun over HTTPS.",
        },
        {
            icon: Eye,
        ...
        },
        {
            ...
            description: "Applikasjonen kjører på sikre plattformer (Vercel, Heroku) med brannmur og tilgangskontroll. Cloudflare brukes for DDoS-beskyttelse og SSL/TLS.",
        },
        {
            icon: RefreshCw,
            title: "Automatisk utlogging",
            description: "Sesjoner utløper automatisk. Ved inaktivitet eller utløpt sesjon må du logge inn på nytt. Clerk håndterer sesjon og valgfri to-faktor.",
        },
    ];
