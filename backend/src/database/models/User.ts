...
UserSchema.index({ "oauthAccounts.email": 1 }, { sparse: true, name: "oauth_accounts_email" });
...
UserSchema.index({ email: 1, deletedAt: 1 }, { name: "email_deleted_at" });
...
UserSchema.index({ clerkId: 1, deletedAt: 1 }, { name: "clerkid_deletedat" });
